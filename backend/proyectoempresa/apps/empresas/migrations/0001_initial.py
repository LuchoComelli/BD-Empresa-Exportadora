    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brochure', models.FileField(blank=True, help_text='Subir archivo PDF o imagen del brochure/catálogo', null=True, upload_to=apps.empresas.models.generar_nombre_catalogo, verbose_name='Brochure o Catálogo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empresa', models.ForeignKey(help_text='Empresa que ofrece este producto (debe ser tipo producto o mixta)', limit_choices_to={'tipo_empresa_valor__in': ['producto', 'mixta']}, on_delete=django.db.models.deletion.CASCADE, related_name='productos_empresa', to='empresas.empresa', verbose_name='Empresa')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('moneda_precio', models.CharField(choices=[('ARS', 'Pesos Argentinos'), ('USD', 'Dólares'), ('EUR', 'Euros')], default='ARS', max_length=3, verbose_name='Moneda del Precio')),
                ('empresa', models.ForeignKey(help_text='Empresa mixta que ofrece este producto', limit_choices_to={'tipo_empresa_valor': 'mixta'}, on_delete=django.db.models.deletion.CASCADE, related_name='productos_mixta', to='empresas.empresa', verbose_name='Empresa')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empresa', models.ForeignKey(help_text='Empresa que ofrece este servicio (debe ser tipo servicio o mixta)', limit_choices_to={'tipo_empresa_valor__in': ['servicio', 'mixta']}, on_delete=django.db.models.deletion.CASCADE, related_name='servicios_empresa', to='empresas.empresa', verbose_name='Empresa')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empresa', models.ForeignKey(help_text='Empresa mixta que ofrece este servicio', limit_choices_to={'tipo_empresa_valor': 'mixta'}, on_delete=django.db.models.deletion.CASCADE, related_name='servicios_mixta', to='empresas.empresa', verbose_name='Empresa')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empresa', models.ForeignKey(blank=True, help_text='Empresa a la que se aplica esta clasificación', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='clasificaciones_exportador', to='empresas.empresa', verbose_name='Empresa')),
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('empresa',), name='unique_matriz_empresa')],
            },
        ),
        migrations.CreateModel(
