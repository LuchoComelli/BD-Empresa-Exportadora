...
export default function RegistroPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!formData.departamento || formData.departamento.trim() === '') {
        alert('Por favor, completa el campo de Departamento')
        return
      }
      ...
      const registrationData: any = {
        ...
        departamento: formData.departamento ? String(formData.departamento).trim() : '',
        ...
        sitioweb: formData.paginaWeb || null,
        ...
        productos: tipoNegocio === "servicios" ? [] : productos.map(p => ({
          ...
          capacidad_productiva: p.capacidadProductiva,
        })),
      ...
      alert(
        `Registro enviado exitosamente. Tu cuenta ha sido creada.\n\n` +
        `Email: ${contactoPrincipal.email}\n` +
        `Contraseña inicial: ${formData.cuit}\n\n` +
        `Puedes iniciar sesión ahora. Te recomendamos cambiar tu contraseña después del primer acceso.`
      )
      router.push("/login")
    } catch (error: any) {
      console.error("Error en registro:", error)
      console.error("Stack trace:", error.stack)
      alert(error.message || "Error al enviar el registro. Por favor, revisa la consola del navegador para más detalles e intenta nuevamente.")
    }
  }
  ...
  const agregarProducto = () => {
    setProductos([
      ...productos,
      { id: Date.now().toString(), nombre: "", posicionArancelaria: "", descripcion: "", capacidadProductiva: "" },
    ])
  }
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setFormData({ ...formData, razonSocial: toUpperCase(e.target.value) })}
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setFormData({ ...formData, nombreFantasia: toUpperCase(e.target.value) })}
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setFormData({ ...formData, tipoSociedad: value })}
                    >
                      <SelectTrigger>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                              ...
                              <Input
                                ...
                                onChange={(e) =>
                                  actualizarProducto(producto.id, "capacidadProductiva", toUpperCase(e.target.value))
                                }
                  ...
                  <div className="space-y-4 pt-4 border-t">
                    ...
                    <div className="space-y-4 pt-4 border-t">
                      ...
                      <LocationPicker
                        ...
                        onChange={(coords) => setFormData({ ...formData, geolocalizacion: coords })}
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setFormData({ ...formData, exporta: value })}
                    >
                      <SelectTrigger>
                        <SelectValue placeholder="Selecciona una opción" />
                      </SelectTrigger>
                  ...
                  {formData.exporta === "si" && (
                    <div>
                      ...
                      <Textarea
                        ...
                        onChange={(e) => setFormData({ ...formData, destinoExportacion: toUpperCase(e.target.value) })}
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setFormData({ ...formData, importa: value })}
                    >
                      <SelectTrigger>
                        <SelectValue placeholder="Selecciona una opción" />
                      </SelectTrigger>
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setFormData({ ...formData, materialPromocion: value })}
                    >
                      <SelectTrigger>
                        <SelectValue placeholder="Selecciona una opción" />
                      </SelectTrigger>
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={(e) => setFormData({ ...formData, observaciones: toUpperCase(e.target.value) })}
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setFormData({ ...formData, certificadoMiPyme: value })}
                    >
                      <SelectTrigger>
                  ...
                  <div>
                        ...
                        <div key={cert.id} className="flex items-center gap-2">
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              setFormData({ ...formData, certificaciones: current.join(", ") })
                            }}
                          />
                    ...
                    <Textarea
                      ...
                      onChange={(e) => setFormData({ ...formData, certificaciones: toUpperCase(e.target.value) })}
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          if (e.target.files?.[0]) {
                            ...
                            setFormData({ ...formData, catalogoPdf: file, brochureUrl: file.name })
                          }
                        }}
                        className="hidden"
                      />
