...
export default function RevisarEmpresa() {
  const { id } = useParams()
  ...
  const handleApprove = () => {
    console.log("Approving company:", formData.id)
  ...
  const handleReject = () => {
    ...
    if (reason) {
      console.log("Rejecting company:", formData.id, "Reason:", reason)
